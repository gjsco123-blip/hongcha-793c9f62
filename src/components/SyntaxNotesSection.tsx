...
const TAG_OPTIONS = [
  ...
  "to부정사", "명사절", "가주어/진주어", "가목적어/진목적어", "5형식", "4형식",
  "병렬구조", "전치사+동명사", "비교구문", "수일치", "생략", "숙어/표현",
  "동격접", "동명사주어", "강조구문", "현재완료+수동", "계속적용법 관계대명사",
  "계속적 용법 관계부사", "대동사", "전치사+관계대명사", "분사",
  "as 형부 as", "so~that", "to be pp", "too~to", "기타",
];
