...
const s = StyleSheet.create({
  ...
  synWord: { width: "25%" as any, fontSize: 7, fontWeight: 600, color: T.g50, lineHeight: 1.3, borderRightWidth: 0.5, borderRightColor: T.rule, paddingRight: 4 },
  synSyn: { width: "40%" as any, fontSize: 7, color: T.black, lineHeight: 1.3, paddingLeft: 4 },
